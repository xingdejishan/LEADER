...
from scrstudio.utils.decorators import check_main_thread, decorate_all
from scrstudio.utils.printing import human_format
...
def setup_event_writer(
    ...
    log_dir: Path,
    experiment_name: str,
    project_name: str = "scrstudio-project",
) -> None:
    """Initialization of all event writers specified in config
    Args:
        config: configuration to instantiate loggers
...
class WandbWriter(Writer):
    ...
    def __init__(self, log_dir: Path, experiment_name: str, project_name: str = "scrstudio-project"):
