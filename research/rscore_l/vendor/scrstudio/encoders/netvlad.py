...
@dataclass
class NetVLADConfig(InstantiateConfig):

    _target: Type = field(default_factory=lambda: NetVLAD)
    name: str = "netvlad"
    whiten: bool = True
...
class NetVLAD(nn.Module):
    ...
    def __init__(self, config: NetVLADConfig):
        ...
        checkpoint_path = Path(
            torch.hub.get_dir(), "netvlad", config.model_name + ".mat"
        )
