...
def main():
    ...
    model = MultimodalSurfaceRotation().cuda().eval()
    ...
    payload = dict(protocol='local905_gt_isolated_online_v1', subset=args.subset, predictions=output,
                   ...
                   elapsed_seconds=time.perf_counter()-started, magic=True, translation_frozen=True,
                   timing_scope='Surface pair cache loading and learned rotation; excludes raw/SAM/map/cache construction',
