...
def evaluate(checkpoint, directory, subset, args):
    run(['tools.eval_gravity_fusion', '--cache', args.cache, '--checkpoint', checkpoint,
...
def main():
    ...
    source_names = ('models/gravity_fusion.py', 'models/rigid_landmark.py', 'tools/build_gravity_cache.py',
                    'tools/gravity_fusion_data.py', 'tools/eval_gravity_fusion.py', 'tools/train_gravity_fusion.py',
                    'tests/test_gravity_fusion.py', 'tools/eval_local905_gt.py',
                    'models/sc2pcr.py', 'utils/full_pool_robust_v1.py',
                    'experiments/gravity_fusion/PLAN.md', 'experiments/gravity_fusion/audit.json')
    protocol = dict(name='gravity_fusion_v1', source_commit=args.source_commit,
    ...
    model = MultimodalGravityFusion().cuda()
